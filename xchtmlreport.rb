class Xchtmlreport < Formula
  ...
  homepage "https://github.com/eMxPi/XCTestHTMLReport"
  url "https://github.com/eMxPi/XCTestHTMLReport/archive/2.0.0.tar.gz"
  sha256 "4424d673d578e84e67fd96afa53a5bd3e80ec7acade65365a123af358c77b47e"
  head "https://github.com/eMxPi/XCTestHTMLReport.git", :branch => "develop"
